...
HRESULT MyPoly::Poly::CreateVertexBuffer() {
	...
	//{
	//	D3DXVECTOR3(-0.1f,-0.1f,0.0f),D3DXVECTOR2(0,1),//頂点１
	//	D3DXVECTOR3(-0.1f,0.1f,0.0f),D3DXVECTOR2(0,0),//頂点２
	//	D3DXVECTOR3(0.1f,-0.1f,0.0f),D3DXVECTOR2(1,1),//頂点３
	//	D3DXVECTOR3(0.1f,0.1f,0.0f),D3DXVECTOR2(1,0),//頂点４
	//};
...
HRESULT MyPoly::Poly::CreateVBFront() {
	SimpleVertex vertices[] =
	{
		D3DXVECTOR3(-0.1f,-0.1f,-0.1f),D3DXVECTOR2(0,1),//頂点１
		D3DXVECTOR3(-0.1f,0.1f,-0.1f),D3DXVECTOR2(0,0),//頂点２
		D3DXVECTOR3(0.1f,-0.1f,-0.1f),D3DXVECTOR2(1,1),//頂点３
		D3DXVECTOR3(0.1f,0.1f,-0.1f),D3DXVECTOR2(1,0),//頂点４
	};
	D3D11_BUFFER_DESC bd; //説明書
	bd.Usage = D3D11_USAGE_DEFAULT;
	bd.ByteWidth = sizeof(SimpleVertex) * 4;
