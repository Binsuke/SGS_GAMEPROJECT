...
void CD3DXMESH::Render(D3DXMATRIX& mView,D3DXMATRIX& mProj,D3DXVECTOR3& vLight,D3DXVECTOR3& vEye)
{
	...
	D3DXMATRIX mWorld,mTran,mYaw,mRot,mPitch,mRoll,mScale;
	//ワールドトランスフォーム（絶対座標変換）
	...
	//回転により、ローカル軸を曲げる
	D3DXVec3TransformCoord(&m_AxisX,&D3DXVECTOR3(1,0,0),&mRot);
	D3DXVec3TransformCoord(&m_AxisZ,&D3DXVECTOR3(0,0,1),&mRot);
