...
public:
	...
	void MoveWorldForward(float deltaTime);
	void MoveWorldBackward(float deltaTime);
	void MoveWorldRight(float deltaTime);
	void MoveWorldLeft(float deltaTime);
...
private:
	...
	void UpdateCenter(D3DXMATRIX mWorld);

	void UpdateCenter();

	//void UpdateModelSize(int iLv);
	...
	D3DXVECTOR3 m_vWorldUp;
	D3DXVECTOR3 m_vWorldRight;
