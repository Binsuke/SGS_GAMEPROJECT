...
,m_vWorldForward(0,0,1),m_vWorldRight(1,0,0),m_vWorldUp(0,1,0)
,m_fAnimTime(1.0f),m_bAnimeFlg(false),m_fAnimeWaitTime(0.0f)
{
...
{
	m_vPos += m_fPolySize * m_iModelSizeZ * m_vWorldForward * deltaTime;

	//if (!m_bAnimeFlg) {
	//	m_bAnimeFlg = true; 
	//	m_vPos += m_fPolySize * m_iModelSizeZ * m_vWorldForward;
	//}
	//if (m_bAnimeFlg) {
...
{
	m_vPos += m_fPolySize * m_iModelSizeX * m_vWorldRight * deltaTime;

	/*if (!m_bAnimeFlg) {
		m_bAnimeFlg = true;
		m_vPos += m_fPolySize * m_iModelSizeX * m_vWorldRight;
	}
	if (m_bAnimeFlg) {
		m_fAnimeWaitTime += deltaTime * m_fAnimTime;
		if (m_fAnimTime <= m_fAnimeWaitTime) {
