...
void MAIN::Render()
{
	...
	if (DeltaFPS->DeltaReady())
	{
		...
		if (m_eMoveVec == eMoveVec::Left) {
			...
			bool check = m_pTestModel->AnimationLocalLeft(DeltaFPS->GetDeltaTime());
		...
		if (m_eMoveVec == eMoveVec::Forward) {
			...
			bool check = m_pTestModel->AnimationLocalForward(DeltaFPS->GetDeltaTime());
		...
		if (m_eMoveVec == eMoveVec::Backward) {
			...
			bool check = m_pTestModel->AnimationLocalBackward(DeltaFPS->GetDeltaTime());
