...
void MyModel::Render(D3DXMATRIX view,D3DXMATRIX proj)
{
	...
	D3DXMATRIX mW = mRotX * mRotZ * mTran * m_mAdjustment;
...
//
//
//		D3DXVECTOR3 vRightUnder(0, 0, 0);
//		vRightUnder.x = m_iModelSizeX * m_fPolyHalfSize;
//		D3DXVECTOR3 vCenter(0, 0, 0);
//		vCenter.x = m_iModelSizeX * m_fPolyHalfSize * 0.5f;
//		vCenter.y = m_iModelSizeY * m_fPolyHalfSize * 0.5f;
//
//		D3DXMATRIX mRotZ;
//
//		D3DXMatrixRotationZ(&mRotZ, m_fAnimationRotX / 180 * D3DX_PI);
//
//		D3DXVec3TransformCoord(&vRightUnder, &vRightUnder, &mRotZ);
//
//		//m_vPos = vRightUnder;
//		//m_vPos.y =  vRightUnder.y - vCenter.y;
//		//m_vPos.x += vRightUnder.x - vCenter.x;
//	}
//}
