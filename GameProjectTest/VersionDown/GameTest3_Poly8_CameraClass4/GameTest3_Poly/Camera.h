...
public:
	...
	void GetMoveLocalForwardVec(D3DXVECTOR3* pvWorldVec);
	void GetMoveLocalBackwardVec(D3DXVECTOR3* pvWorldVec);
	void GetMoveLocalRightVec(D3DXVECTOR3* pvWorldVec);
	void GetMoveLocalLeftVec(D3DXVECTOR3* pvWorldVec);
...
private:
	...
	float m_fTransDir;
	static float m_fRotSize;

	static float m_fRotMargine;
