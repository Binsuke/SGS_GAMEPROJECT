...
float GroundPanel::PanelSize = MyPoly::Poly::PolySize * 100;
...
HRESULT GroundPanel::CreateVertexBuffer() {
	...
	float halfsize = PanelSize/2.0f;
	SimpleVertex vertices[] =
	{
		D3DXVECTOR3(-halfsize,0.0f,-halfsize),D3DXVECTOR2(0,1),//頂点１
		D3DXVECTOR3(-halfsize,0.0f,halfsize),D3DXVECTOR2(0,0),//頂点２
		D3DXVECTOR3(halfsize,0.0f,-halfsize),D3DXVECTOR2(1,1),//頂点３
		D3DXVECTOR3(halfsize,0.0f,halfsize),D3DXVECTOR2(1,0),//頂点４
	};
