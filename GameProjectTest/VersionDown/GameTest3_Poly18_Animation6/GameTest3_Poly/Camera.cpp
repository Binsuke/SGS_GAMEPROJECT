...
void Camera::InitCamera()
{
	...
	m_bMoveFlg = false;
	m_vWorldForward = D3DXVECTOR3(0, 0, 1);
}
...
void Camera::GetMoveLocalVecA(D3DXVECTOR3* pOutWorldVec, eGetLocalType eType)
{
	*pOutWorldVec = SwitchVectorA(eType, m_vWorldForward);
}

void Camera::UpDateWorldVec()
{
	m_bMoveFlg = true;
	if (360.0f - ms_fRotMargine < m_vRot.y && 0 + ms_fRotMargine > m_vRot.y
		|| 45.0f - ms_fRotMargine < m_vRot.y && 45.0f + ms_fRotMargine > m_vRot.y
