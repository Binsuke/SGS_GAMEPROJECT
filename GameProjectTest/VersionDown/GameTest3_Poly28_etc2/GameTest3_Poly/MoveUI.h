...
public:
	...
	void Render(D3DXMATRIX view, D3DXMATRIX proj, D3DXVECTOR3 center, float length, D3DXVECTOR3 vForward,int iLV);
...
private:
	...
	void RenderW(D3DXMATRIX view, D3DXMATRIX proj, D3DXVECTOR3 pos,int iLV);;
	void RenderA(D3DXMATRIX view, D3DXMATRIX proj, D3DXVECTOR3 pos,int iLV);;
	void RenderS(D3DXMATRIX view, D3DXMATRIX proj, D3DXVECTOR3 pos,int iLV);;
	void RenderD(D3DXMATRIX view, D3DXMATRIX proj, D3DXVECTOR3 pos,int iLV);;

	static float m_sfScale;

	static float m_sfLengthPer;
